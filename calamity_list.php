    ...
    <div class="container">
        ...
        <main>
            <header>
                ...
                <div class="add-calamity-container">
    <a href="add_calamity.php" class="add-calamity-btn">Add Calamity</a>
</div>

<section id="calamity-card" class="main-content dropdown">
    <?php
    // Database connection
    require 'db_connect.php';
    ...
    // Check if there are any calamities to display
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            $calamityType = $row['type'];
            $icon = '';

            // Determine the icon based on the calamity type
            switch ($calamityType) {
                case 'Typhoon':
                    $icon = '<img src="icons/hurricane.png" alt="Fire Sign Icon" style="width: 50px; height: 50px;" />';
                    break;
                case 'Flood':
                    $icon = '<img src="icons/sea-level.png" alt="Fire Sign Icon" style="width: 50px; height: 50px;" />';
                    break;
                case 'Earthquake':
                    $icon = '<img src="icons/earthquake.png" alt="Fire Sign Icon" style="width: 50px; height: 50px;" />';
                    break;
                case 'Fire Incident':
                    $icon = '<img src="icons/fire-sign.png" alt="Fire Sign Icon" style="width: 50px; height: 50px;" />';
                    break;
                default:
            ...
            echo '<div class="view-details-container">';
             echo '<a href="calamity_view.php?id=' . $row['id'] . '"><button class="view-details-btn">View Details</button></a>';
            echo '</div>';

            echo '</div>';
        }
    } else {
        echo '<p>No recent calamities recorded.</p>';
    }
    ?>
</section>
</main>
